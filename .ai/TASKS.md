...
| T-004 | outbox-reactive module (ReactiveOutboxService + R2dbcOutboxService) | claude | codex | claude | ready_for_review | New module in parent POM; ReactiveOutboxService interface; R2dbcOutboxService impl; unit tests with StepVerifier; compile and tests pass | `mvn -q -DskipTests test-compile` ✅, `mvn -T 1C -q test` ✅ | review |
