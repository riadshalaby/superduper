...
| T-005 | Outbox configuration + TopicRegistry merge + starter wiring | claude | codex | claude | ready_for_review | OutboxProperties config; outbox entries in TopicRegistry; OutboxService/ReactiveOutboxService beans wired; coverage aggregation; compile and tests pass | `mvn -q -DskipTests test-compile` ✅, `mvn -T 1C -q test` ✅ | review |
