...
public final class PostgresR2dbcSqlDialect implements R2dbcSqlDialect {
    ...
    public String fetchClaimedByIdsSqlTemplate() {
        return "SELECT id, key AS message_key, content, retry_count, container_id FROM messages WHERE id IN (%s) ORDER BY key, id";
    }
